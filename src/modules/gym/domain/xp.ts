...
import { detectPrs, recordSetIntoHistory } from "./prs";
import { detectBodyweightPrs, recordBodyweightIntoHistory } from "./bodyweight";
import { requireExercise } from "./registry";
import { MUSCLE_IDS } from "./muscles";
import { emptyBodyweightHistory } from "./types";
import type {
  Exercise,
  ExerciseHistory,
  HistoryContext,
