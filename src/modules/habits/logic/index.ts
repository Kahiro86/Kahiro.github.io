...
import type { Db, Entry, Habit } from "./dbTypes";
import {
...
import { effectiveStart, type Period } from "./period";
import {
  getFrequencyShape, periodContaining, computeQuotaState, type QuotaState,
} from "./frequency";
import { cache } from "./cache";

export { getScoreColor, SCORE_COLOR_HEX, computeScoreOrNull } from "./core";
export { isCompleted, allowsExplicitMiss } from "./completion";
export { cache, LogicCache } from "./cache";
export {
  getFrequencyShape, quotaUnit, quotaRequired, describeQuota,
  periodContaining, computeQuotaState,
} from "./frequency";
export type { FrequencyShape, QuotaState, QuotaUnit } from "./frequency";
export type {
  StreakRun, TrendPoint, HistoryBucket, HeatmapDay, ScoreColor, EntryMap, DateSpan,
} from "./core";
export type { Period } from "./period";
export { effectiveStart, habitCreatedDate } from "./period";
export { getListView, listDays, buildListView, DEFAULT_LIST_DAYS } from "./listView";
export type { ListView, ListGroup, ListRow, ListCell, CellState, ListOptions } from "./listView";
export { getDetailHeader, getOverview, describeFrequency, computeOverview, spanForDetail } from "./detail";
export {
  getCalendarMonth, getStreaksView, buildCalendarMonth, frequencyDots,
  describeDay, stepMonth, WEEK_DOT_LABELS,
} from "./calendar";
export type { CalendarMonth, CalendarDay, StreaksView } from "./calendar";
export type { DetailHeader, Overview } from "./detail";
export {
...
export type { HabitDraft, DraftProblem, StorageSummary } from "./editor";
export {
...
export type { DueHabit, HabitSummary, CompletionRow } from "./aggregates";
export { exportAll, validateImport, importAll, backupFilename, BACKUP_FORMAT } from "./backup";
export type { BackupFile, ImportReport, ImportProblem } from "./backup";
