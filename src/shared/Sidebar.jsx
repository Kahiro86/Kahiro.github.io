...
export function Sidebar({ active, onNavigate, collapsed, onToggle, onOpenSettings, overlay }) {
  ...
  const overlayStyle = overlay
    ...
    : {};
  return (
    <div style={{ width: isCollapsed ? 64 : 226, height: "100vh", background: "rgba(9,13,24,0.62)", backdropFilter: "blur(15px) saturate(125%)", WebkitBackdropFilter: "blur(15px) saturate(125%)", borderRight: `1px solid ${BD}`, display: "flex", flexDirection: "column", flexShrink: 0, transition: "width 0.28s cubic-bezier(0.4,0,0.2,1)", overflow: "hidden", ...overlayStyle }}>
