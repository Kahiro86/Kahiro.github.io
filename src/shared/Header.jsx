...
export function Header({ module, aiOpen, onAIToggle, isMobile, onMenu }) {
  ...
  if (isMobile) {
    return (
      <div style={{ height: 56, background: B1, borderBottom: `1px solid ${BD}`, display: "flex", alignItems: "center", padding: "0 12px", gap: 10, flexShrink: 0 }}>
  ...
  return (
    <div style={{ height: 60, background: B1, borderBottom: `1px solid ${BD}`, display: "flex", alignItems: "center", padding: "0 22px", gap: 16, flexShrink: 0 }}>
      <div style={{ flex: 1 }}>
