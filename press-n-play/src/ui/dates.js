...
/**
 * The Sunday that begins the week containing `ds`.
 *
 * Noon-anchored like everything else here, so a daylight-saving change
 * cannot push the date across a boundary mid-calculation.
 */
export const weekStartStr = (ds = localDateStr()) => {
